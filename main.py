...
BANK_DETAILS = {
    "sber": {
        "name": "Сбербанк",
        "card_number": "2202 2023 4567 8901",  # Номер твоей карты Сбер
        "recipient": "ИВАН ИВАНОВ",  # Твое имя как на карте
        "color": "🟢",
        "description": "Перевод по номеру карты"
    },
    "tinkoff": {
        "name": "Тинькофф", 
        "card_number": "5536 9137 1234 5678",  # Номер твоей карты Тинькофф
        "recipient": "ИВАН ИВАНОВ",  # Твое имя как на карте
        "color": "🟡",
        "description": "Перевод по номеру карты"
    }
